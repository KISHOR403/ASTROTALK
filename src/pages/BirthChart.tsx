...
import { Sparkles, Calendar, Clock, User, ArrowRight, Download, Info, ChevronDown, ChevronUp, AlertCircle } from 'lucide-react';
              ...
              <div className="grid lg:grid-cols-2 gap-8">
                ...
                <div className="glass-card p-6 md:p-8">
                  <div className="flex justify-between items-center mb-6">
                    <div>
                      <h3 className="font-display text-xl font-semibold">Rashi Chart (Kundli)</h3>
